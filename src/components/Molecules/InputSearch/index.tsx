...
const InputSearch = ({ style, placeholder, onFocus, onBlur }: Props) => {
  ...
  return (
    <Row centred>
      <TouchableOpacity style={styles.searchBarContainer} onPress={onFocusInput}>
        <View style={[styles.searchBar, style]}>
          <FontAwesomeIcon style={styles.searchIcon} icon="search" color={colors.light.neutralDark} />

          <TextInput ref={inputRef} placeholder={placeholder} onFocus={onFocusInput} />
        </View>
      </TouchableOpacity>
