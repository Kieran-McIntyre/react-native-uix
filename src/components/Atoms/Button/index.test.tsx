...
describe('Atoms - Button', () => {
    ...
    it('should render title', () => {
        // Arrange.
        const { getByTestId } = render(<Button title={title} onPress={mockPressFn} />)
    ...
    it('is disabled > should be disabled', () => {
        // Arrange.
        const { getByTestId } = render(<Button title={title} onPress={mockPressFn} disabled={true} />)
        const label = getByTestId('button__label')
    ...
    it('is submit type > should be submit type', () => {
        // Arrange.
        const { getByTestId } = render(<Button title={title} onPress={mockPressFn} submit={true} />)
        const label = getByTestId('button__label')
